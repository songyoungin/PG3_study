...
parser.add_argument('--netG', default='C:\\Users\\USER\Desktop\PG3-study\GAN\Pix2Pix\samples\\ver2\\netG_epoch_168.pth', help="path to netG (to continue training)")
parser.add_argument('--netD', default='C:\\Users\\USER\Desktop\PG3-study\GAN\Pix2Pix\samples\\ver2\\netD_epoch_168.pth', help="path to netD (to continue training)")

parser.add_argument('--out_folder', default='samples\\ver2', help='folder to output images and model checkpoints')
