    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for step, (real_data, _) in enumerate(self.dataloader):
                ...
                # create the labels
                target_real = torch.ones(self.batch_size).to(device)
                # print("target_real shape:", target_real.shape)

                target_fake = torch.zeros(self.batch_size).to(device)
        ...
        torch.save(self.g, "weights/DCGAN_celebA_generator.pth")
        torch.save(self.d, "weights/DCGAN_celebA_discriminator.pth")
